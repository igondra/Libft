...
/*   Updated: 2022/05/20 12:01:15 by igondra-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* int	main(void)
{
	...
	// Defino dos lista independientes. Ahora \
	voy a añadir new_list a previous_list

	ft_lstadd_front(&previous_list, new_list);
	printf("El contenido del nodo nuevo es: %s", previous_list->content);
	free(previous_list);
	free(new_list);
	// Ahora el puntero previous_list apunta al nodo \
	new, de manera que el content será "Kaixo"
} */
